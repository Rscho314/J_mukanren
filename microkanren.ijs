...
unify =: 2 : ']`(u&walk exts ] v&walk)`(v&walk exts ] u&walk)`(}.@u&walk $: }.@v&walk ] {.@u&walk $: {.@v&walk)`]`(mzero"_)@.(1 i.~ (u&walk vareqhuh v&walk)`([: varhuh u&walk)`([: varhuh v&walk)`(''''&-:&}.@(u&walk) *: ''''&-:&}.@(v&walk))`(u&walk -: v&walk)`:0)'
